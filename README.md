# Twepline's Contributor License Agreement (CLA)

If you're interested in contributing to Twepline, you will first need to sign a Contributor License Agreement.
...
Twepline's CLA is signed on a per-GitHub-account basis, requiring you to reveal no personal information.

To sign the CLA, create a PR to this repository that adds a file in the `signatures` folder with your GitHub username. For example, `signatures/Bard.md`.  
...
You can see an example of this process at [#1](https://github.com/Twepline/CLA/pull/1).
